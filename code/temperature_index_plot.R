...
read_csv("data/GLB.Ts+dSST.csv", skip=1, na = "***") %>%
  ...
  scale_y_continuous(limit=c(-0.5, 1.5), expand = c(0,0)) +
  ...
  labs(
    ...
    title = "GLOBAL LAND_OCEAN TEMPERATURE INDEX",
    subtitle = "Annual mean combined land-surface air and sea-surface water temperature",
...
ggsave("figure/temperature_index_plot.png", width = 6, height = 4)
